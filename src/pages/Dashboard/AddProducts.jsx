...
const AddProducts = () => {
        ...
        const imageFormData = new FormData()
           ...
           if(imageResult.success){
            ...
            const res =  await fetch('http://localhost:5000/products',{
              ...
              if(result.insertedId || result._id || result.success){
                Swal.fire({
  ...
  return (
    <div>
        ...
        <h2 className='text-3xl font-bold items-center text-center'>Add an Product</h2>
        <div className=''>
            <form onSubmit={handleSubmit(onSubmit)} >
                ...
                <button className='btn mt-8 bg-orange-500 text-white' type='submit'>Add Product <FaUtensils/></button>
            </form>
        </div>
    </div>
  )
